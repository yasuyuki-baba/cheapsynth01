#include "CS01VCOComponent.h"
#include "../Parameters.h"

CS01VCOComponent::CS01VCOComponent(juce::AudioProcessorValueTreeState& apvts) : valueTreeState(apvts)
{
...
void CS01VCOComponent::parameterValueChanged(int parameterIndex, float newValue)
{
...
void CS01VCOComponent::parameterGestureChanged(int parameterIndex, bool gestureIsStarting)
{
