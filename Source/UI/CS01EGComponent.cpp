#include "CS01EGComponent.h"
#include "../Parameters.h"

CS01EGComponent::CS01EGComponent(juce::AudioProcessorValueTreeState& apvts) : valueTreeState(apvts)
{
...
CS01EGComponent::~CS01EGComponent() {}

void CS01EGComponent::paint(juce::Graphics& g)
{
