#include "CS01VCAProcessor.h"

//==============================================================================
CS01VCAProcessor::CS01VCAProcessor(juce::AudioProcessorValueTreeState& apvts)
...
CS01VCAProcessor::~CS01VCAProcessor()
{
}

//==============================================================================
void CS01VCAProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void CS01VCAProcessor::releaseResources()
{
    inputHighPass.reset();
    dcBlocker.reset();
    highFreqRolloff.reset();
...
bool CS01VCAProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
...
void CS01VCAProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
float CS01VCAProcessor::processVCA(float input, float controlVoltage, float volumeParam)
{
...
float CS01VCAProcessor::processTr7Buffer(float input)
{
...
float CS01VCAProcessor::processOutputCoupling(float input)
{
