#include "CS01MidiProcessor.h"
#include "../Parameters.h"
#include "CS01SynthVoice.h"

CS01MidiProcessor::CS01MidiProcessor(juce::AudioProcessorValueTreeState& apvts)
    : AudioProcessor(BusesProperties()), // No audio buses
      apvts(apvts)
{
}

CS01MidiProcessor::~CS01MidiProcessor() = default;

void CS01MidiProcessor::prepareToPlay(double, int) {}
void CS01MidiProcessor::releaseResources() {}

void CS01MidiProcessor::processBlock(juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
void CS01MidiProcessor::handleMidiEvent(const juce::MidiMessage& midiMessage, juce::MidiBuffer&)
{
...
void CS01MidiProcessor::handleNoteOn(const juce::MidiMessage& midiMessage)
{
...
void CS01MidiProcessor::handleNoteOff(const juce::MidiMessage& midiMessage)
{
...
void CS01MidiProcessor::handlePitchWheel(const juce::MidiMessage& midiMessage)
{
...
void CS01MidiProcessor::handleControllerMessage(const juce::MidiMessage& midiMessage)
{
