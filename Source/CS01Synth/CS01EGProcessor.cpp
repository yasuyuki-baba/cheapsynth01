...
//==============================================================================
CS01EGProcessor::CS01EGProcessor(juce::AudioProcessorValueTreeState& apvts)
...
CS01EGProcessor::~CS01EGProcessor()
{
}

//==============================================================================
void CS01EGProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    adsr.setSampleRate(sampleRate);
    updateADSR();
}

void CS01EGProcessor::releaseResources()
{
}

bool CS01EGProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
...
void CS01EGProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
void CS01EGProcessor::updateADSR()
{
