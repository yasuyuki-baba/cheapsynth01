...
//==============================================================================
class CS01EGProcessor  : public juce::AudioProcessor
{
public:
    //==============================================================================
    CS01EGProcessor(juce::AudioProcessorValueTreeState& apvts);
    ~CS01EGProcessor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (CS01EGProcessor)
};
