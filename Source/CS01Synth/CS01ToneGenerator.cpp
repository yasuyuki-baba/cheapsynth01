...
CS01ToneGenerator::CS01ToneGenerator(juce::AudioProcessorValueTreeState& apvts) : apvts(apvts) {}

void CS01ToneGenerator::prepare(const juce::dsp::ProcessSpec& spec)
{
...
void CS01ToneGenerator::updateBlockRateParameters()
{
...
void CS01ToneGenerator::setNote(int midiNoteNumber, bool isLegato)
{
    if (isLegato)
    {
...
void CS01ToneGenerator::calculateSlideParameters(int targetNote)
{
...
bool CS01ToneGenerator::isNoiseMode() const
{
    return currentFeet == Feet::WhiteNoise;
}

float CS01ToneGenerator::getNextSample()
{
    if (isSliding)
    {
        stepCounter++;
...
float CS01ToneGenerator::generateVcoSample()
{
...
void CS01ToneGenerator::setLfoValue(float newLfoValue)
{
    lfoValue = newLfoValue;
}

void CS01ToneGenerator::setVcoFrequency(float frequency)
{
    phaseIncrement = frequency / sampleRate;
}

void CS01ToneGenerator::setPitchBend(float bendInSemitones)
{
